...
class RecordViewModel(private  val app: Application): AndroidViewModel(app) {
    ...
    private val sec: Long = 1_000L
    private var preferences = app.getSharedPreferences("info.fandroid.voicerecorder", Context.MODE_PRIVATE)
    ...
    private fun createTimer() {
        viewModelScope.launch {
            ...
            timer = object : CountDownTimer(triggerTime, sec) {
